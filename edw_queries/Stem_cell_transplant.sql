...
-- Stem cell transplant codes (separately specify ICD-9 and ICD-10 here to avoid V/Z code overlap)
where (dt.diagnosis_code in ('V42.81', 'V42.82') and dt.diagnosis_code_set in ('ICD-9-CM'))
OR (dt.diagnosis_code in ('Z94.81', 'Z94.84') and dt.diagnosis_code_set in ('ICD-10-CM'))
